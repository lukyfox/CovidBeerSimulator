...
if __name__ == '__main__':
    ...
    parser.add_argument("--steps", help="pocet kroku - hodnota je pouzita pro vsechny simulace; pri neuvedeni argumentu je vychozi hodnota 720")
    parser.add_argument("--configle", help="cesta k csv souboru s konfiguraci simulace (simtyp;sekvence resp. simtyp;sekvence1,sekvence2)")
...
#             #   misto); mody lze skladat (_wd); pokud neni uvedeno jinak, jedna se o antigenni test, pokud je uvedeno "p",
#             #   jedna se o test PCR metodou (napr. test_wp = testovani na pracovisti metodou PCR), testy PCR a antigen nelze
#             #   v soucasne implementaci aplikovat spolecne (TODO: umoznit soubeznou aplikaci PCR a antigennich testu)
